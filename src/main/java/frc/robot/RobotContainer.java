...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    m_button11.whenPressed(new BumpDriveGain(-0.05));
    m_button9.whenPressed(new BumpDriveGain(0.05));

    m_button12.whenPressed(new BumpTwistGain(-0.05));
    m_button10.whenPressed(new BumpTwistGain(0.05));
