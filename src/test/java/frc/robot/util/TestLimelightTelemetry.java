...
// library.
/**
 * Test the {@link LimelightTelemetry} class methods. The {@link LimelightTelemetry} is completely independent
 * of the {@link RobotTelemetry} class, so it is important that these tests pass before the tests in
 * {@link TestRobotLimelightTelemetry} are expected to pass.
 */
@RunWith(JUnitPlatform.class)
public class TestLimelightTelemetry {
}
